...
export default class MultiSelect extends Component {
  static propTypes = {
    ...
    styleRowText: ViewPropTypes.style,
    styleRowTextSelected: ViewPropTypes.style,
    styleWraperRowText: ViewPropTypes.style,
    styleWraperRowTextSelected: ViewPropTypes.style,
  ...
  _addItem = () => {
    const {uniqueKey, items, selectedItems, onSelectedItemsChange, onAddItem} =
      this.props
    let newItems = []
        ...
        <View>
          <View
            style={[
              ...
              styleWraperRowText && styleWraperRowText,
              selected ? styleWraperRowTextSelected : {},
            ]}>
            <Text
              style={[
                {
              ...
              <View
                ...
                <TouchableWithoutFeedback onPress={this._toggleSelector}>
                  <View
                    ...
                    <Icon
                      name={hideSubmitButton ? 'chevron-down' : 'chevron-up'}
                      size={18}
                      color="#515151"
                    />
                  </View>
